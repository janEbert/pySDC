...
class allinclusive_newton_nonMPI(allinclusive_multigrid_nonMPI):
    ...
    def run_with_pred(self, uk, u0, t0, Tend):
        ...
        self.set_jacobian(uk=uk, t=time)
        ...
        while any(active):
            ...
            while norm_rhs > 1E-08:  # TODO!!!
                ...
                print('  Outer Iter: %i -- number of inner solves: %i -- Newton res: %8.6e'
    ...
    def run(self, u0, t0, Tend):
        ...
        while any(active):
            ...
            k = 0
            while norm_rhs > self.params.outer_restol:# or k==0: # and k<4 :
                k += 1
        ...
        #    for b in a:
        #        print("test", b.values)
        #print("final", uend.values)
        #print("finalsum", uend3)
        return uk, self.hooks.return_stats()
    ...
    def set_jacobian(self, uk=None, t=0):

...
from pySDC.projects.parallelPFASST.div_generic_implicit_MPI import div_generic_implicit_MPI

class div_linearized_implicit_parallel_MPI(div_generic_implicit_MPI):
    """
    ...
    def __init__(self, params):
        ...
        super(div_linearized_implicit_parallel_MPI, self).__init__(params)

...
class AC_jac(allencahn_fullyimplicit):
    ...
    def eval_jacobian(self, u):
        ...
        dfdu = self.A + 1.0/self.params.eps ** 2 * sp.diags(1.0 - (self.params.nu + 1) * v ** self.params.nu, offsets=0)
        return dfdu
    ...
    def solve_system_jacobian(self, dfdu, rhs, factor, u0, t):
        ...
        #print(dfdu)
        #print(sp.eye(self.params.nvars[0]*self.params.nvars[1]))
        mat = sp.eye(self.params.nvars[0]*self.params.nvars[1]) - factor * dfdu

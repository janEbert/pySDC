...
from pySDC.implementations.problem_classes.GrayScott_1D_FD_jac import grayscott_fullyimplicit, grayscott_fullyimplicit_jac
...
###############################################################################################################################
    ...
    level_params = dict()
    level_params['restol'] = 1E-4 #10
    level_params['dt'] = 1 #1E-03
    level_params['nsweeps'] = [1]

    # This comes as read-in for the step class (this is optional!)
    step_params = dict()
    step_params['maxiter'] = 1#50

    # This comes as read-in for the problem class
    problem_params = dict()
    problem_params['nvars'] = [128] #, 64]  #[(256,256), (128, 128)] #[16 , 8] #[(256,256), (128, 128)]  #[(256,256), (128, 128)] #[512, 256] 
    problem_params['newton_maxiter'] = 1#00
    problem_params['newton_tol'] = 1E-12#4
    problem_params['lin_tol'] = 1E-09
    problem_params['lin_maxiter'] = 1#100
    ...
    t0 = 0
    Tend = 2 #0.024 #01 #08 #0.01 #08 #04 #32
